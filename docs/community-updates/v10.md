...
- Galactic Republic
    - COMMANDER [Clone Jet Trooper]
    - LEGACY [Clone Sharpshooter]
    - SNIPER [Clone Commando]
...
- Separatist Alliance
    ...
    - KALLER [Officer]
    - ASSASSIN [Specialist]
    - SPEEDER PILOT [Specialist]

- Rebel Alliance
    - BLUE SQUADRON [Rebel Pilot]
    - Y-WING PILOT [Rebel Pilot]

- Galactic Empire
    - ARMY SECURITY
    - MUDTROOPER
    - NAVY TROOPER [Officer]
    - STAR TOURS [Imperial Jumptrooper]
    - ARATECH 11-3K [Viper Probe Droid]

- First Order
    - SNOWTROOPER [Heavy, Officer, Specialist, Stormtrooper Commander]
    - EXECUTIONER [Riot Control Trooper]
...
To guard an objective or pathway, Zam can deploy a <img class="ability" class="no-lb" src="../../assets/abilities/heroes/zam/Ability_Minecraft.svg"> **CONCUSSION MINE** up to three times, which will knock down and daze affected enemies. 
