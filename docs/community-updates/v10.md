...
We've also taken the time to fix a number of broken abilities and Star Cards, such as incorrect positions whenever using Yoda's <img class="ability" class="no-lb" src="../../assets/community-updates/v10/Yoda_Ability_02.svg"> **PRESENCE**, Bossk's <img class="ability" class="no-lb" src="../../assets/community-updates/v10/Bosk_Ability_01.svg"> **SPREADING THE DISEASE** Star Card doing nothing, and more.
...
- **Heroes**
    ...
    - Darth Maul
        - THROWN TO SLOW Star Card
            - Fixed an issue with CHOKE HOLD not receiving the correct amount of bonus damage.
    ...
    - Finn
        - NO MORE RUNNING
            - Fixed an issue with the bonus damage applying without having to obtain 3 kills with DEADEYE like the description states.
            - Fixed an issue with the end damage being below that of lower card values.
