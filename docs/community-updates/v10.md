...
- **Troopers**
    - Appearances
        - Galactic Republic
            - Added Captain appearance to the Assault, Heavy, Officer, and Specialist.
            - Added Commander appearance to the Assault, Heavy, Officer, and Specialist.
            - Added Lieutenant appearance to the Assault, Heavy, Officer, and Specialist.
            - Added Sergeant appearance to the Assault, Heavy, Officer, and Specialist.
            - Added Horn Company appearance to the Assault, Heavy, Officer, and Specialist.
            - Added Outer Rim Garrison appearance to the Assault, Heavy, Officer, and Specialist.
            - Added Rancor Battalion appearance to the Assault, Heavy, Officer, and Specialist.
            - Added Kamino Security appearance to the Assault, Heavy, Officer, and Specialist.
...
- **Reinforcements**
    ...
    - Republic Gunner
        ...
        - Added Captain, Commander, Horn Company, Kamino Security, Lieutenant, Lightning Squadron, Outer Rim Garrison, Rancor Battalion, Sergeant, 13th Battalion, 187th Battalion appearances.
...
- **Troopers**
    ...
    - Abilities and Star Cards
        - DISRUPTION
            - Fixed an issue with incorrect connections.
        - INSTIGATOR
...
- **Reinforcements**
    ...
    - Caphex Spy
        - TRUNCHEON STRIKES
            - Fixed an issue with the missing closer attack animation.
    - Clone Flametrooper
        - THERMOBARIC BARRAGE
...
- **Autoplayers**
    ...
    - Fixed an issue with Officer DISRUPTION having incorrect connections.
    - Fixed an issue with Specialist SCRAMBLER INFILTRATION not working correctly.
    - Fixed an issue regarding the Resistance Officer spawning with an extra amount of Disrupt kits and no Defuser kits.
