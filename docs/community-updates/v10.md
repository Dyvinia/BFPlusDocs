...
### **HEROES**
Battlefront+ Across the Stars introduces the most heroes added yet, bringing in some of the community's most desired characters and at long last fulfilling two promises of our own.
...
As a military mastermind of legend, it was an important challenge to emphasize Thrawn's role as a exceptional tactician. <img class="ability" class="no-lb" src="../../assets/abilities/heroes/thrawn/Thrawn_Ability_Defender.svg"> **KNOW THE ENEMY** serves to turn the opponent's strategies against themselves, revealing Thrawn's attackers to his entire team and inflicting them with weakness, an effect with strengthens as he withstands their assault. Enduring enough attacks will inflict greater weakness on all enemies within a large radius and inhibit their abilities. 
...
- **Reinforcements**
    ...
    - Clone Flametrooper
        - BT X-42 HEAVY FLAME PROJECTOR
            - Added effects to enemies actively taking damage from burning.
        - SCORCHING CHARGE
            - Fixed the lack of burning damage applied to enemies when they are slammed by the charge attack.
            - Added effects to enemies actively taking damage from burning.
        - MELEE
            - Added effects to enemies actively taking damage from burning.
...
- **Gamemodes**
    - Arcade
        - Fixed crashing when attempting to play Arcade.

![main](../assets/gallery/temp_v10_cover.png){ .round-corners } 