  ...
  <div class="card" >
    ...
    <div class="card-content">
      <div class="card-title">
        ...
        <p>B2 Super Battle Droid<img class="h3-icon" class="no-lb" src="../../assets/abilities/reinfocements/Class_JumpTrooper.svg"></p>
      </div>
    </div>
    <div class="card-backdrop"></div>
  </div>
...
**Royal Guard** <img class="reinforcement-type" class="no-lb" src="../../assets/abilities/reinfocements/Class_Enforcer.svg">

- Light Armor - Combat armor variant as seen onboard the Chimaera in *Rebels*.
- Shadow Guard - Black variant of the Ceremonial Robes with a red visor.
